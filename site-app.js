...
(function () {
  ...
  const SCENE_LIST = ['hero','crisis','gap','meet','loop','modes','flywheel','datasphere','databricks','agentic','integration','kpis','scope','team','cta'];
  ...
  function updateScrollScene() {
    ...
    if (scene !== currentScene) {
      ...
      const navMap = { problem:['crisis','gap'], loop:['loop'], modes:['modes'], architecture:['flywheel','datasphere','databricks','agentic','integration'], kpis:['kpis','scope'], team:['team','cta'] };
